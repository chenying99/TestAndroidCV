...
import com.yeyupiaoling.cv.mnn.MNNClassification;
...
public class MNNClassificationActivity extends AppCompatActivity {
    private static final String TAG = MNNClassificationActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classification_mnn);
        classification_model_path = getCacheDir().getAbsolutePath() + File.separator + "mobilenet_v2.mnn";
        Utils.copyFileFromAsset(MNNClassificationActivity.this, "mobilenet_v2.mnn", classification_model_path);
        classification_quant_model_path = getCacheDir().getAbsolutePath() + File.separator + "mobilenet_v2_quant.mnn";
        Utils.copyFileFromAsset(MNNClassificationActivity.this, "mobilenet_v2_quant.mnn", classification_quant_model_path);
        initView();
        selectModelDialog();
    }
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isInfer) {
                    ...
                    Toast.makeText(MNNClassificationActivity.this, "正在预测中，请勿重复点击按钮", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(MNNClassificationActivity.this, "模型加载成功！", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(MNNClassificationActivity.this, "模型加载失败！", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                    finish();
                }
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == 1) {
                ...
                image_path = Utils.getPathFromURI(MNNClassificationActivity.this, image_uri);
                // predict image
                try {
