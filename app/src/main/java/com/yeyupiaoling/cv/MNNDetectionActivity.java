...
import com.yeyupiaoling.cv.mnn.MNNDetection;
...
public class MNNDetectionActivity extends AppCompatActivity {
    private static final String TAG = MNNDetectionActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mnndetection);
        String detection_model_path = getCacheDir().getAbsolutePath() + File.separator + "ssd_mobilenet_v1.mnn";
        Utils.copyFileFromAsset(MNNDetectionActivity.this, "ssd_mobilenet_v1.mnn", detection_model_path);
        try {
            mnnDetection = new MNNDetection(detection_model_path);
        } catch (Exception e) {
            e.printStackTrace();
            Log.d(TAG, "模型加载失败");
