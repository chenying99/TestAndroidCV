...
public class PaddleClassificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classification_paddle);
        classification_model_path = getCacheDir().getAbsolutePath() + File.separator + "mobilenet_v2.nb";
        Utils.copyFileFromAsset(PaddleClassificationActivity.this, "mobilenet_v2.nb", classification_model_path);
        classification_quant_model_path = getCacheDir().getAbsolutePath() + File.separator + "mobilenet_v2_quant.nb";
        Utils.copyFileFromAsset(PaddleClassificationActivity.this, "mobilenet_v2_quant.nb", classification_quant_model_path);
        initView();
        selectModelDialog();
    }
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isInfer) {
                    ...
                    Toast.makeText(PaddleClassificationActivity.this, "正在预测中，请勿重复点击按钮", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(PaddleClassificationActivity.this, "模型加载成功！", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(PaddleClassificationActivity.this, "模型加载失败！", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                    finish();
                }
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == 1) {
                ...
                image_path = Utils.getPathFromURI(PaddleClassificationActivity.this, image_uri);
                // predict image
                try {
